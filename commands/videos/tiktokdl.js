...
module.exports = async function ({ dstryr, event, parameters }) {
  ...
  f (parameters.length === 0) {
            dstryr.sendMessage('Please provide a TikTok link to proceed to execute.?,/nusage:*toktik tiktokurl', event.threadID);
            return;
        }
    ...
    //copypas
    var msg1 = {
      body: "Downloading the TikTok video you provide, Please wait while fetching the data API....... "
    };
    ...
    var msg2 = {
      body: `Video Successfully Downloaded...`,
